...
import static test.connect.myapplication.api.ApiClientFactory.GetTriviaApi;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText questionIn = findViewById(R.id.activity_main_question_edit_text);
        ...
        postByPathBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                GetTriviaApi().PostTriviaByPath(questionIn.getText().toString(), answerIn.getText().toString()).enqueue(new SlimCallback<Trivia>(trivia ->{
                    RegenerateAllTriviasOnScreen(apiText1);
                    questionIn.setText("");
                    answerIn.setText("");
                }));
